...
var GPX_PARSERS = {
  'gpx': {
    ...
    'wpt': WPT_PARSERS,
    'trk': {
      $: parser.appendToCollection('track'),
      'name': { $text: stringParser('name') },
      'desc': { $text: stringParser('notes') },
      'link': parseLink,
      'trkseg': {
    ...
    'rte': {
      $: parser.appendToCollection('route'),
      'name': { $text: stringParser('name') },
      'desc': { $text: stringParser('notes') },
      'rtept': RTEPT_PARSERS
    }
